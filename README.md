...
InSpec profile (overlay) to validate the secure configuration of AWS RDS hosted PostgreSQL Database to validate compliancy with [Department of Defense (DoD) STIG](https://public.cyber.mil/stigs/) `Crunchy Data PostgreSQL 16` Security Technical Implementation Guide (STIG) requirements.

- Profile Version: **1.1.0**
- Benchmark Date: **20 Jun 2024**
- Benchmark Version: **Version 1 Release 1 (V1R1)**

> [!Note]
> This Profile applies to database versions 16 and greater.
...
```
# How to run
inspec exec https://github.com/mitre/aws-rds-crunchy-data-postgresql-16-stig-baseline/archive/main.tar.gz --input-file=<path_to_your_inputs_file/name_of_your_inputs_file.yml> --reporter=json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
mkdir profiles
cd profiles
git clone https://github.com/mitre/aws-rds-crunchy-data-postgresql-16-stig-baseline
inspec archive aws-rds-crunchy-data-postgresql-16-stig-baseline
...
```
cd aws-rds-crunchy-data-postgresql-16-stig-baseline
git pull
cd ..
inspec archive aws-rds-crunchy-data-postgresql-16-stig-baseline --overwrite
inspec exec <name of generated archive> -t ssh:// --input-file=<path_to_your_inputs_file/name_of_your_inputs_file.yml> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
To report a bug or feature request, please open an [issue](https://github.com/mitre/aws-rds-crunchy-data-postgresql-16-stig-baseline/issues/new).
